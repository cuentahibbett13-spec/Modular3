...
Versión optimizada para MI210 con 64GB VRAM
"""
...
def get_dataloaders(data_dir='results/iaea_final', batch_size=16, num_workers=4, 
                   train_pairs=None, val_pairs=None, augment=True, seed=42):
    """
    Crear DataLoaders para training y validation
    Optimizado para MI210 (64GB VRAM) - batch_size y num_workers aumentados
    
    Args:
        data_dir: Directorio base con datasets
        batch_size: Tamaño de batch (16 para MI210 vs 4 para RTX 5060)
        num_workers: Workers para carga (4 vs 0 para GPU móvil)
...
if __name__ == '__main__':
    # Test
    print("Testing DoseDataset for MI210...")
